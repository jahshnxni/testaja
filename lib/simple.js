...
exports.makeWASocket = (connectionOptions, options = {}) => {
  ...
  conn.sendMessageModify = async (_0x2dd0c2, _0x3c18d6, _0x20c790, _0x5d8134, _0x3a8a22 = {}) => {
    await conn.sendPresenceUpdate("composing", _0x2dd0c2);
    if (_0x5d8134.thumbnail) {
      var {
        file: _0x31775b
      } = await Func.getFile(_0x5d8134.thumbnail);
    }
    return conn.sendMessage(_0x2dd0c2, {
      'text': _0x3c18d6,
      ..._0x3a8a22,
      'contextInfo': {
        'mentionedJid': await conn.parseMention(_0x3c18d6),
        'externalAdReply': {
          'title': _0x5d8134.title || global.set.wm,
          'body': _0x5d8134.body || null,
          'mediaType': 0x1,
          'previewType': 0x0,
          'showAdAttribution': !!(_0x5d8134.ads && _0x5d8134.ads),
          'renderLargerThumbnail': !!(_0x5d8134.largeThumb && _0x5d8134.largeThumb),
          'thumbnail': _0x5d8134.thumbnail ? await Func.fetchBuffer(_0x31775b) : await Func.fetchBuffer(db.data.settings[conn.user.jid].cover),
          'thumbnailUrl': "https://starvxantiaja.000webhostapp.com/anjir.jpg",
          'sourceUrl': "https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8"
        }
      }
    }, {
      'quoted': _0x20c790
  ...
  conn.sendContact = async (jid, contact, quoted, info = {}, opts = {}) => {
    ...
    contact.map(v => list.push({
      displayName: v.name,
      vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:${v.name}\nORG:${info && info.org ? info.org : 'StarVX Store'}\nTEL;type=CELL;type=VOICE;waid=${v.number}:${PhoneNumber('+' + v.number).getNumber('international')}\nEMAIL;type=Email:${info && info.email ? info.email : 'starvxstore@gmail.com'}\nURL;type=Website:${info && info.website ? info.website : 'https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8'}\nADR;type=Location:;;Unknown;;\nOther:${v.about}\nEND:VCARD`
    }))
