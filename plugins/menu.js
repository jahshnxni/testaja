...
let handler = async (m, {
  ...
  try {
    ...
    if (style === 1) {
      ...
      const defaultMenu = {
        before: `Hai, %tag👋!
Hi! I am StarVX Bot If you need this bot you can add me to your grup..... OH Yeahhh Don't forget to buy VPS/RDP/PANEL di Starvx Store dan disitu juga menjual jasa pembuatan GTPS

∘  *Version* : 1.0 (Beta anjink)
∘  *Owner* : wa.me/6288808912762
∘  *Group* : https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8
...
%readmore`.trimStart(),
      ...
      if (teks == '404') {
        ...
        caption += `Hi! I am StarVX Bot If you need this bot you can add me to your grup..... OH Yeahhh Don't forget to buy VPS/RDP/PANEL di Starvx Store dan disitu juga menjual jasa pembuatan GTPS.\n\n`
        caption += `∘  *Version* : 1.0\n`
        caption += `∘  *Link Gruop* : https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8\n`
