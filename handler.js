    ...
    try {
      ...
      try {
        ...
        if (chat) {
          ...
          if (!('sWelcome' in chat)) chat.sWelcome = `✧━━━━[ *WELCOME* ]━━━━✧
...
@desc`,
        ...
        if (settings) {
          ...
          if (!'owners' in settings) settings.owners = ['62888089127620', '6288808912762']
          if (!'link' in settings) settings.link = 'https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8'
          if (!'cover' in settings) settings.cover = 'https://starvxantiaja.000webhostapp.com/anjir.jpg'
          ...
          rpg: false,
          style: 2,
          owners: ['62888089127620', '6288808912762'],
          link: 'https://chat.whatsapp.com/HFehIHEBodM6Zzyr6WMOr8',
          cover: 'https://starvxantiaja.000webhostapp.com/anjir.jpg'
        }
      } catch (e) {
        console.error(e)
      }
